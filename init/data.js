...
let sampleListings = [
  ...
  },
  {
    ...
    country: 'United States',
    reviews: [],
    geometry: { type: 'Point', coordinates: [ 153.4887893, -28.2181323 ] },
  ...
  },
  {
    ...
    country: 'Tanzania',
    reviews: [],
    geometry: { type: 'Point', coordinates: [ -71.0465793333333, 42.334094 ] },
  ...
  },
  {
    ...
    reviews: [],
    geometry: { type: 'Point', coordinates: [ 151.4090342, -33.4373422 ] },
...
//   let res  = await sample.geometry()
//       sample.geometry = res.body.features[0].geometry
